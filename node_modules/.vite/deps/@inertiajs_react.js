...
function Te(r4, e, t, i = "brackets") {
  let n = /^https?:\/\//.test(e.toString()), a = n || e.toString().startsWith("/"), c = !a && !e.toString().startsWith("#") && !e.toString().startsWith("?"), d = e.toString().includes("?") || r4 === "get" && Object.keys(t).length, m = e.toString().includes("#"), h = new URL(e.toString(), "http://localhost");
  return r4 === "get" && Object.keys(t).length && (h.search = M.stringify((0, import_deepmerge.default)(M.parse(h.search, { ignoreQueryPrefix: true }), t), { encodeValuesOnly: true, arrayFormat: i }), t = {}), [[n ? `${h.protocol}//${h.host}` : "", a ? h.pathname : "", c ? h.pathname.substring(1) : "", d ? h.search : "", m ? h.hash : ""].join(""), t];
}
function V(r4) {
  ...
  function m() {
    let l = e(""), v2 = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, _2 = Object.values(i).reduce((S, E) => S.concat(E), []).reduce((S, E) => {
      ...
      if (E.indexOf("<title ") === 0) {
        let H2 = E.match(/(<title [^>]+>)(.*?)(<\/title>)/);
        return S.title = H2 ? `${H2[1]}${e(H2[2])}${H2[3]}` : E, S;
      }
...
var le2 = (0, import_react8.forwardRef)(({ children: u2, as: o2 = "a", data: n = {}, href: s2, method: a = "get", preserveScroll: m = false, preserveState: p2 = null, replace: g2 = false, only: P2 = [], except: y2 = [], headers: l = {}, queryStringArrayFormat: e = "brackets", async: f2 = false, onClick: t = k2, onCancelToken: h = k2, onBefore: T2 = k2, onStart: x2 = k2, onProgress: I2 = k2, onFinish: q2 = k2, onCancel: N2 = k2, onSuccess: J2 = k2, onError: O2 = k2, prefetch: F2 = false, cacheFor: b2 = 0, ...Q2 }, Y2) => {
  ...
  let U2 = { data: n, method: a, preserveScroll: m, preserveState: p2 ?? a !== "get", replace: g2, only: P2, except: y2, headers: l, async: f2 }, $2 = { ...U2, onCancelToken: h, onBefore: T2, onStart(c) {
    ...
    V2((d) => d - 1), q2(c);
  }, onCancel: N2, onSuccess: J2, onError: O2 }, w2 = () => {
...
function me2(u2, o2) {
  let n = (0, import_react9.useRef)(null), s2 = typeof u2 == "string" ? u2 : null, [a, m] = (0, import_react9.useState)((typeof u2 == "string" ? o2 : u2) || {}), p2 = (0, import_react9.useRef)(null), g2 = (0, import_react9.useRef)(null), [P2, y2] = s2 ? H(a, `${s2}:data`) : (0, import_react9.useState)(a), [l, e] = s2 ? H({}, `${s2}:errors`) : (0, import_react9.useState)({}), [f2, t] = (0, import_react9.useState)(false), [h, T2] = (0, import_react9.useState)(false), [x2, I2] = (0, import_react9.useState)(null), [q2, N2] = (0, import_react9.useState)(false), [J2, O2] = (0, import_react9.useState)(false), F2 = (0, import_react9.useRef)((i) => i);
  (0, import_react9.useEffect)(() => (n.current = true, () => {
    n.current = false;
  }), []);
  let b2 = (0, import_react9.useCallback)((i, S, r4 = {}) => {
    let c = { ...r4, onCancelToken: (d) => {
      if (p2.current = d, r4.onCancelToken) return r4.onCancelToken(d);
    }, onBefore: (d) => {
      if (N2(false), O2(false), clearTimeout(g2.current), r4.onBefore) return r4.onBefore(d);
    }, onStart: (d) => {
      if (T2(true), r4.onStart) return r4.onStart(d);
    }, onProgress: (d) => {
      if (I2(d), r4.onProgress) return r4.onProgress(d);
    }, onSuccess: (d) => {
      if (n.current && (T2(false), I2(null), e({}), t(false), N2(true), O2(true), g2.current = setTimeout(() => {
        n.current && O2(false);
      }, 2e3)), r4.onSuccess) return r4.onSuccess(d);
    }, onError: (d) => {
      if (n.current && (T2(false), I2(null), e(d), t(true)), r4.onError) return r4.onError(d);
    }, onCancel: () => {
      if (n.current && (T2(false), I2(null)), r4.onCancel) return r4.onCancel();
    }, onFinish: (d) => {
      if (n.current && (T2(false), I2(null)), p2.current = null, r4.onFinish) return r4.onFinish(d);
    } };
    i === "delete" ? Wr.delete(S, { ...c, data: F2.current(P2) }) : Wr[i](S, F2.current(P2), c);
  }, [P2, e, F2]), Q2 = (0, import_react9.useCallback)((i, S) => {
    y2(typeof i == "string" ? (r4) => ({ ...r4, [i]: S }) : typeof i == "function" ? (r4) => i(r4) : i);
  }, [y2]), Y2 = (0, import_react9.useCallback)((i, S) => {
    m(typeof i > "u" ? () => P2 : (r4) => ({ ...r4, ...typeof i == "string" ? { [i]: S } : i }));
  }, [P2, m]), z2 = (0, import_react9.useCallback)((...i) => {
    i.length === 0 ? y2(a) : y2((S) => Object.keys(a).filter((r4) => i.includes(r4)).reduce((r4, c) => (r4[c] = a[c], r4), { ...S }));
  }, [y2, a]), V2 = (0, import_react9.useCallback)((i, S) => {
    e((r4) => {
      let c = { ...r4, ...typeof i == "string" ? { [i]: S } : i };
      return t(Object.keys(c).length > 0), c;
    });
  }, [e, t]), D2 = (0, import_react9.useCallback)((...i) => {
    e((S) => {
      let r4 = Object.keys(S).reduce((c, d) => ({ ...c, ...i.length > 0 && !i.includes(d) ? { [d]: S[d] } : {} }), {});
      return t(Object.keys(r4).length > 0), r4;
    });
  }, [e, t]), E = (i) => (S, r4) => {
    b2(i, S, r4);
